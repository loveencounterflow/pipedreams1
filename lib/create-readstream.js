...
(function() {
  var ProgressBar, after, get_filesize, njs_fs;
  ...
  this.create_readstream = function(route, label) {
     ...
     */
    var CombinedStream, R, bar, bar_is_shown, collected_bytes, format, is_first_call, options, partial_route, routes, size, timer, _i, _len;
  ...
  module.exports = this.create_readstream;
