...
(function() {
  var ES, HELPERS, S, TEXT, TRM, alert, badge, debug, echo, get_random_integer, help, info, log, njs_util, rainbow, rnd_from_seed, rpr, urge, warn, whisper;
  ...
  this.$throttle = function(bytes_per_second) {
    var Throttle;
