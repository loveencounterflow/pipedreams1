...
(function() {
  var ES, S, TEXT, TRM, alert, badge, debug, echo, get_random_integer, help, info, log, njs_util, rainbow, rnd_from_seed, rpr, through, urge, warn, whisper;
  ...
  this.through = through.bind(through);
