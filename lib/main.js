...
(function() {
  var COPYPASTE, ES, HELPERS, S, TEXT, TRM, TYPES, alert, badge, create_levellivestream, debug, echo, get_random_integer, help, info, log, njs_util, rainbow, rnd_from_seed, rpr, urge, warn, whisper,
    __slice = [].slice;
